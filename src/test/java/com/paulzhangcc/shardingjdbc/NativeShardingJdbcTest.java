 ...
 * @date 2019/11/7
 */
public class NativeShardingJdbcTest {
    public static DataSource dataSource() throws SQLException {
        // 配置真实数据源
        Map<String, DataSource> dataSourceMap = new HashMap<>();

        DruidDataSource dataSource1 = new DruidDataSource();
        dataSource1.setUrl("jdbc:mysql://10.129.26.5:3306/shardingjdbc?useUnicode=true&characterEncoding=utf-8&useSSL=false&useAffectedRows=true&allowMultiQueries=true");
        ...
        dataSource2.setUrl("jdbc:mysql://10.129.26.6:3306/shardingjdbc?useUnicode=true&characterEncoding=utf-8&useSSL=false&useAffectedRows=true&allowMultiQueries=true");
